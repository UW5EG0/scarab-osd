...
/********************       STARTUP settings      *********************/
//#define INTRO_VERSION               "Slava Ukrayini" // Call the OSD something else if you prefer.
...
#define INTRO_DELAY 0              // Seconds intro screen should show for. Default is 6
...
#define OSDSUMMARY 0               // Seconds summary is displayed for after landing. Max 254
...
#define TX_CHANNELS 5             // Amend if require up to 16 RC channels (APM/PX4/MAVLINK are 16 by default)
